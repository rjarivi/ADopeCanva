        ...
        return (
            <div className="container mx-auto px-6 h-[85vh] flex flex-col justify-center animate-fade-in text-center">
                ...
                <div className="flex-none space-y-3 mb-10">
                    <h1 className="text-4xl lg:text-5xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-red-400 to-orange-500 flex items-center justify-center gap-3 font-unbounded uppercase">
                        <FileText size={40} /> PDF Studio
                    </h1>
                    <p className="text-lg text-zinc-400 max-w-2xl mx-auto font-medium">
                        A professional-grade toolkit to merge, split, and rotate PDF documents with high-performance browser-side processing.
                    </p>
                </div>
                ...
                <div className="flex-1 w-full max-w-4xl mx-auto bg-zinc-900/50 border border-zinc-800/50 rounded-3xl p-2 flex flex-col items-center justify-center relative overflow-hidden group hover:border-red-500/50 transition-colors shadow-2xl">
                    ...
                    <FileUploader
                        ...
                        multiple={mode === 'merge'}
                        className="w-full h-full border-2 border-dashed border-zinc-800 hover:border-red-500/50 bg-zinc-950/50 rounded-2xl transition-all"
                    />
                </div>
                ...
                <div className="flex-none max-w-4xl mx-auto w-full grid grid-cols-2 md:grid-cols-4 gap-4 mt-10">
                    {[
                        { icon: Layers, label: 'Merge', desc: 'Combine multiple files' },
                        { icon: Scissors, label: 'Split', desc: 'Extract specific pages' },
                        { icon: RotateCw, label: 'Rotate', desc: 'Fix orientation' },
                        { icon: Download, label: 'Export', desc: 'High quality output' }
                    ].map((feat, i) => (
