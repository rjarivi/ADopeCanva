...
export const BackgroundRemover: React.FC = () => {
  ...
  if (!file) {
    return (
      <div className="container mx-auto px-6 h-full flex flex-col justify-center animate-fade-in text-center py-8">
        {/* Header */}
        <div className="flex-none space-y-3 mb-8">
          <h2 className="text-4xl font-black tracking-tight text-white flex items-center justify-center gap-3 font-unbounded">
            <Eraser size={32} className="text-indigo-400" /> Smart Background Remover
          </h2>
          <p className="text-base md:text-lg text-zinc-400 max-w-2xl mx-auto">
            Isolate subjects with 100% private, on-device AI. Choose between BiRefNet (bg0 engine) or MODNet — both 100% open-source with full commercial rights.
          </p>
        </div>

        {/* Model Selection Selector Bar */}
        <div className="flex-none max-w-2xl mx-auto w-full mb-6 text-left">
        ...
        <div className="flex-1 w-full max-w-4xl mx-auto bg-zinc-900/50 border border-zinc-800/50 rounded-3xl p-2 flex flex-col items-center justify-center relative overflow-hidden group hover:border-indigo-500/50 transition-colors shadow-2xl">
          ...
          <FileUploader
            ...
            label="Upload Image"
            description="Supports JPG, PNG, WEBP, AVIF, HEIC — processed locally in browser"
        ...
        {/* Feature Highlights (4-column grid per AGENTS.md) */}
