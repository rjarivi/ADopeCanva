  ...
  if (!file) {
    return (
      <ToolShell
        icon={EyeOff}
        title="EXIF Stripper"
        description="Inspect hidden camera info, remove GPS geo-tags, and sanitize photos before sharing."
        features={[
        ...
        uploadLabel="Drop Photo Here to Inspect & Sanitize"
        uploadDescription="Supports JPEG, PNG, WebP, and TIFF camera photos"
