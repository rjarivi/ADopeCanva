        ...
        return (
            <div className="max-w-3xl mx-auto space-y-8 animate-fade-in">
                <div className="text-center space-y-2">
                    <h2 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-400 to-indigo-400">
                        Audio Trimmer Studio
                    </h2>
                    <p className="text-zinc-400">Trim and cut audio files with precision.</p>
                </div>
