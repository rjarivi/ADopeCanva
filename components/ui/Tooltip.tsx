...
export const Tooltip: React.FC<TooltipProps> = ({ content, children, position = 'top' }) => {
  ...
  return (
    ...
    >
      {children}
      {isVisible && (
        <div className={`absolute z-50 px-2 py-1 text-xs font-medium text-white bg-zinc-800 border border-zinc-700 rounded shadow-xl whitespace-nowrap animate-fade-in ${positionClasses[position]}`}>
          {content}
          {/* Arrow */}
